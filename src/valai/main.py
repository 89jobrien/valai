...
# # Import the dynamically created Route class from the single source of truth
# from valai.agents.base import Route, load_agents, load_router
# from valai.core.console import console
# from valai.core.history import ConversationHistory
...
# class Assistant:
#     """Orchestrates the agent routing and execution logiconsole."""

#     def __init__(self):
#         """Initializes the assistant by loading the router and specialist agents."""
#         logger.add(
#             "logs/valai_assistant.log",
#             rotation="10 MB",
#             level="INFO",
...
#     def process_query(self, query: str) -> str:
#         """Processes a single user query from routing to final response."""
#         self.history.add("user", query)
...
#         while True:
#             try:
#                 # The user's raw query is now used directly.
#                 user_query = input("You: ")
#                 if user_query.lower() in ["exit", "quit"]:
#                     break
