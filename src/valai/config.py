...
class AgentToggler(BaseSettings):
    ...
    # This config allows it to read from the .env file, just like the main Settings class.
    # Pydantic will automatically look for environment variables matching the field names.
